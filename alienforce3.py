...
while not closed():
	...
	if   direction == "U":
		...
		polygon(shipx, shipy, shipx + 0.5 * dimension, shipy + dimension, shipx + dimension, shipy)
	elif direction == None or direction == "L":
		polygon(shipx + dimension, shipy, shipx, shipy + 0.5 * dimension, shipx + dimension, shipy + dimension)
	else:
		polygon(shipx, shipy, shipx + dimension, shipy + 0.5 * dimension, shipx, shipy + dimension)
